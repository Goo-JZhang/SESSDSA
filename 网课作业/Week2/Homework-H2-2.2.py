...
for i in range(10**6,10**8,5*(10**5)):
    ...
    timef=timeit.Timer("adict[0]=p","from __main__ import adict,p")
    zero=timeit.Timer("p","from __main__ import p")
    timelist.append(timef.timeit(number=10000000)-zero.timeit(number=10000000))
