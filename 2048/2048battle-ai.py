...
def Evl(my_chessboard, L_atk=0, R_atk=0, v1=1.0, v2=1.0, v3=1.0):
    '''
...
def Threat_Evl(my_chessboard, state, side=1, v1=1.0, v2=1.0, v3=1.0):
    '''
...
def Get_Evl(my_chessboard, state, side=1, L_atk=0, R_atk=0, v1=1.0, v2=1.0, v3=1.0, v4=1.0):
    '''
    棋盘评估结果以先手方为正，后手方为负;
...
a=bytearray(b'0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a1a0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f')
