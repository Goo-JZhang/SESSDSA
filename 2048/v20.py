...
class Player():
    ...
    def chessborad2mine(self,currentRound,board):
        ...
        for x in range(8):
            for y in range(4):
                myboard[8*x+2*y]=board.getBelong((x,y))
                myboard[8*x+2*y+1]=board.getVal((x,y))
    ...
    def move_row(self,mybyte:bytearray(),side: str,chessman : bool):
            '''
    ...
    def move_up(self,lst:[bytearray(),...],chessman : bool):
    ...
    def move_down(self,lst:[bytearray(),...],chessman : bool):
        for i in range(len(lst)):
            if self._where == 1 and i < self.COLLUMS//2 or\
    ...
    def move_left(self,lst:[bytearray(),...],chessman : bool):
    ...
    def move_right(self,lst:[bytearray(),...],chessman : bool):
