...
import random
alist = [1, 0, 1, 1, 1, 2, 1, 3, 1, 3, 1, 2, 1, 1, 1, 0, 1, 0, 1, 1, 1, 2, 1, 3, 1, 3, 1, 2, 1, 1, 1,
         0] + [0, 0, 0, 1, 0, 2, 0, 3, 0, 3, 0, 2, 0, 1, 0, 0, 0, 0, 0, 1, 0, 2, 0, 3, 0, 3, 0, 2, 0, 1, 0, 0]

b = bytearray(alist)
p = Player(False, [1,2,3,4,5])
print(p.answer)
